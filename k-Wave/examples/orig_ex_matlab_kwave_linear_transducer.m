...
% disp(['The stats of the scattering region 1st : ' ...
%     num2str(Nx_tot) ', ' num2str(Ny_tot) ', ' num2str(Nz_tot) ', ' ...
%     num2str(round(x_pos/dx)) ', ' num2str(round(y_pos/dx)) ', ' ...
%     num2str(Nz_tot/2) ', ' num2str(round(radius/dx))]);
